        	...
        	<div class="container">
        		...
        		<div class="row our_bakery_image">
        			<div class="col-md-4 col-6">
        				<img class="img-fluid" src="{{ asset('frontend/img/our-bakery/bakery-1.jpg') }}" alt="">
        			</div>
        			<div class="col-md-4 col-6">
        				<img class="img-fluid" src="{{ asset('frontend/img/our-bakery/bakery-2.jpg') }}" alt="">
        			</div>
        			<div class="col-md-4 col-6">
        				<img class="img-fluid" src="{{ asset('frontend/img/our-bakery/bakery-3.jpg') }}" alt="">
        			</div>
        		</div>
        	</div>
        </section>
